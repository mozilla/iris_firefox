...
class AboutPreferences:
    ...
    class Privacy:
        CONTENT_TRACKING_TRACKERS_CHECKBOX_SELECTED = Pattern(
            "content_blocking_tracking_protection_checkbox_selected.png"
        )
        CONTENT_TRACKING_TRACKERS_CHECKBOX_NOT_SELECTED = Pattern(
            "content_blocking_tracking_protection_checkbox_not_selected.png"
        )
        CONTENT_TRACKING_TRACKERS_ALWAYS_RADIO_SELECTED = Pattern(
            "content_blocking_tracking_protection_option_always_radio_selected.png"
        )
        CONTENT_TRACKING_TRACKERS_ALWAYS_RADIO_NOT_SELECTED = Pattern(
            "content_blocking_tracking_protection_option_always_radio_not_selected.png"
        )
        CONTENT_TRACKING_TRACKERS_ONLY_PRIVATE_WINDOWS_RADIO_SELECTED = Pattern(
            "content_blocking_tracking_protection_option_private_radio_selected.png"
        )
        CONTENT_TRACKING_TRACKERS_ONLY_PRIVATE_WINDOWS_RADIO_NOT_SELECTED = Pattern(
            "content_blocking_tracking_protection_option_private_radio_not_selected.png"
        )
