...
class LocationBar(object):
    ...
    INSECURE_CONNECTION_LOCK_DARK_THEME = Pattern(
        "insecure_connection_lock_dark_theme.png"
    )
    ...
    TRACKING_PROTECTION_SHIELD_ACTIVATED = Pattern(
        "tracking_protection_icon_enabled.png"
    )
    TRACKING_PROTECTION_SHIELD_DEACTIVATED = Pattern(
        "tracking_protection_icon_disabled.png"
    )
    NEW_FIREFOX_CONTENT_BLOCKING_LABEL = Pattern(
        "uitour_tooltip_title_new_in_firefox_content_blocking.png"
    )
