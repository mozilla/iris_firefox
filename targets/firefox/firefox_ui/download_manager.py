...
class DownloadManager(object):
    ...
    class DownloadsPanel(object):
        ...
        NO_DOWNLOADS_FOR_THIS_SESSION = Pattern("empty_downloads.png").similar(0.7)
        ...
        class DownloadDetails(object):
            ...
            BLOCKED_DETAILS_1 = Pattern("downloads_panel_blocked_subview_details_1.png").similar(0.7)
            UNWANTED_DETAILS_1 = Pattern("downloads_panel_blocked_subview_unwanted_details_1.png").similar(0.7)
            UNCOMMON_DETAILS_1 = Pattern("downloads_panel_blocked_subview_uncommon_details_1.png").similar(0.7)
            BLOCKED_DETAILS_2 = Pattern("downloads_panel_blocked_subview_details_2.png").similar(0.7)
