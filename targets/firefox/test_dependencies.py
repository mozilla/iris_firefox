...
from targets.firefox.firefox_ui.helpers.update_rules import (
    is_update_required,
    get_rule_for_channel,
    get_update_rules,
)
...
from targets.firefox.firefox_ui.test_utils import (
    restore_firefox_focus,
    open_clear_recent_history_window,
)
