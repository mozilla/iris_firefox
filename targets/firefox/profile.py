...
class FirefoxProfile(object):
    ...
    def _get_staged_profile(profile_name, path):
        ...
        _staged_profiles = os.path.join(PathManager.get_module_dir(), 'iris', 'profiles')
    ...
    def make_profile(self, template):
        ...
        if template is FirefoxProfile.BRAND_NEW:
            logger.debug('Creating brand new profile: %s' % profile_path)
            prefs = FirefoxProfile.preferences
        elif template in (FirefoxProfile.LIKE_NEW, FirefoxProfile.TEN_BOOKMARKS):
