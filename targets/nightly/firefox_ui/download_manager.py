...
class DownloadManager(object):
    ...
    SHOW_ALL_DOWNLOADS_DARK_THEME = Pattern(
        "downloads_history_show_all_downloads_dark_theme.png"
    )
    ...
    class DownloadsPanel(object):
        ...
        DOWNLOAD_RETRY_HIGHLIGHTED = Pattern("download_retry_highlighted.png").similar(
            0.95
        )
        DOWNLOAD_CANCEL = Pattern("download_cancel.png").similar(0.95)
        DOWNLOAD_CANCEL_HIGHLIGHTED = Pattern(
            "download_cancel_highlighted.png"
        ).similar(0.95)
        ...
        ADD_REMOVE_DOWNLOADS_RED_ARROW = Pattern(
            "download_add_remove_file_red_arrow.png"
        )
        ADD_REMOVE_DOWNLOADS_WHITE_ARROW = Pattern(
            "download_add_remove_file_white_arrow.png"
        )
        ...
        VIRUS_OR_MALWARE_DOWNLOAD_DARK_THEME = Pattern(
            "virus_or_malware_message_dark_theme.png"
        )
        ...
        class DownloadDetails(object):
            ...
            BLOCKED_DOWNLOAD_TITLE = Pattern(
                "downloads_panel_blocked_subview_title.png"
            )
            UNWANTED_DOWNLOAD_TITLE = Pattern(
                "downloads_panel_unwanted_subview_title.png"
            )
            UNCOMMON_DOWNLOAD_TITLE = Pattern(
                "downloads_panel_uncommon_subview_title.png"
            )
            BLOCKED_BADGE = Pattern("downloads_panel_blocked_subview_blocked_badge.png")
            UNWANTED_BADGE = Pattern(
                "downloads_panel_blocked_subview_unwanted_badge.png"
            )
            BLOCKED_DETAILS_1 = Pattern("downloads_panel_blocked_subview_details_1.png")
            UNWANTED_DETAILS_1 = Pattern(
                "downloads_panel_blocked_subview_unwanted_details_1.png"
            )
            UNCOMMON_DETAILS_1 = Pattern(
                "downloads_panel_blocked_subview_uncommon_details_1.png"
            )
            BLOCKED_DETAILS_2 = Pattern("downloads_panel_blocked_subview_details_2.png")
            OPEN_FILE_BUTTON = Pattern(
                "downloads_panel_blocked_subview_open_button.png"
            )
            REMOVE_FILE_BUTTON = Pattern(
                "downloads_panel_blocked_subview_delete_button.png"
            )
            BLOCKED_DOWNLOAD = Pattern("download_details_temporary_blocked.png")
            DOWNLOADS_BACK_ARROW = Pattern(
                "downloads_panel_blocked_subview_back_arrow.png"
            )
    ...
    class DownloadState(object):
        ...
        PROGRESS = Pattern("download_details_left_size.png").similar(0.6)
        PAUSED = Pattern("download_details_paused.png")
        RETRY_DOWNLOAD = Pattern("download_details_retry_download.png").similar(0.6)
