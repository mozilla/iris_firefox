...
class Bookmarks(object):
    class StarDialog(object):
        NEW_BOOKMARK = Pattern("editBookmarkPanelTitle_new_bookmark.png").similar(0.7)
        EDIT_THIS_BOOKMARK = Pattern("editBookmarkPanelTitle_edit_this_bookmark.png")
        NAME_FIELD = Pattern("editBMPanel_nameRow.png")
        PANEL_FOLDER_DEFAULT_OPTION = Pattern(
            "editBMPanel_folderMenuList_default_Other_Bookmarks.png"
        )
        ...
        PANEL_OPTION_BOOKMARK_TOOLBAR = Pattern(
            "editBMPanel_chooseFolderMenuItem_Bookmarks_Toolbar.png"
        )
        PANEL_OPTION_BOOKMARK_MENU = Pattern(
            "editBMPanel_chooseFolderMenuItem_Bookmarks_Menu.png"
        )
        ...
        EDITOR_OPTION_CHECKED = Pattern(
            "editBookmarkPanel_showForNewBookmarks_checked.png"
        )
        EDITOR_OPTION_UNCHECKED = Pattern(
            "editBookmarkPanel_showForNewBookmarks_unchecked.png"
        )
