...
from iris2.src.core.api.enums import Alignment
from iris2.src.core.api.errors import FindError
from iris2.src.core.api.finder.image_search import image_find
from iris2.src.core.api.finder.pattern import Pattern
from iris2.src.core.api.mouse.mouse_controller import Mouse
from iris2.src.core.util.rectangle import Rectangle

try:
    from iris2.src.core.api.mouse.mouse_controller import Button
except AttributeError:
    from iris2.src.core.api.enums import Button
