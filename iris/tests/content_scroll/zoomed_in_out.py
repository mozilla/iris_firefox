...
class Test(BaseTest):
    ...
    def run(self):
        ...
        web_page_loaded_exists = exists(LocalWeb.SOAP_WIKI_SOAP_LABEL, Settings.SITE_LOAD_TIMEOUT)
        ...
        after_zooming_in_content_exists = exists(after_zooming_in_content_pattern, Settings.FIREFOX_TIMEOUT)
        ...
        before_scroll_content_exists = exists(after_zooming_in_content_pattern, Settings.FIREFOX_TIMEOUT)
        ...
        after_scroll_content_exists = exists(after_zooming_in_content_pattern, Settings.FIREFOX_TIMEOUT)
        ...
        after_zooming_out_content_exists = exists(after_zooming_out_content_pattern, Settings.FIREFOX_TIMEOUT)
        assert_true(self, after_zooming_out_content_exists, 'Zoom out action works properly')

        # Scroll up and down using mouse wheel
        before_scroll_content_exists = exists(after_zooming_out_content_pattern, Settings.FIREFOX_TIMEOUT)
        assert_true(self, before_scroll_content_exists, 'Content before scrolling using mouse wheel is on the page')
        ...
        after_scroll_content_exists = exists(after_zooming_out_content_pattern, Settings.FIREFOX_TIMEOUT)
        assert_true(self, after_scroll_content_exists, 'Scroll up and down using mouse wheel is successful.')
