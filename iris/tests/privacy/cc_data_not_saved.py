...
class Test(BaseTest):
    ...
    def run(self):
        ...
        expiration_month_field_pattern = Pattern('expiration_month_field.png')
        expiration_year_field_pattern = Pattern('expiration_year_field.png')
        csc_field_pattern = Pattern('csc_field.png')
        submit_button_pattern = Pattern('submit_button.png')
        entered_csc_pattern = Pattern('entered_csc.png')
