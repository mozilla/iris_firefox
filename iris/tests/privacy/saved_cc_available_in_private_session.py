...
class Test(BaseTest):
    ...
    def run(self):
        ...
        type(Key.ESC)
        add_button_disappeared = not exists(add_button_pattern)
        ...
        click(save_button_pattern)
        credit_card_successfully_saved = exists(visa_logo_pattern, DEFAULT_SYSTEM_DELAY)
        ...
        if Settings.is_linux():
            mouse_move(card_number_field_pattern)
