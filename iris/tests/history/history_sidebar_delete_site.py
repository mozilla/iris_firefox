...
class Test(BaseTest):
    ...
    def run(self):
        ...
        expected_4 = exists(LocalWeb.MOZILLA_BOOKMARK_SMALL, Settings.FIREFOX_TIMEOUT)
        ...
        try:
            expected_5 = wait_vanish(LocalWeb.MOZILLA_BOOKMARK_SMALL, Settings.FIREFOX_TIMEOUT)
