...
class Test(BaseTest):
    ...
    def run(self):
        ...
        getting_started_pattern = Pattern('getting_started_bookmark.png')
        history_bookmarks_toolbar_pattern = Pattern('history_in_bookmarks_toolbar.png')
        ...
        # Search the bookmark toolbar by using the "Getting started" pattern.
        expected = exists(getting_started_pattern, 10)
        assert_true(self, expected, 'Getting started bookmarks was found.')
        getting_started_pattern_location = find(getting_started_pattern)
        right_click(Location(getting_started_pattern_location.x + 200, getting_started_pattern_location.y + 10))
