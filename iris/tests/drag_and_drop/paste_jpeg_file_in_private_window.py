...
class Test(BaseTest):
    ...
    def __init__(self):
        ...
        self.meta = 'Paste .jpeg File in demopage opened in Private Window'
        self.test_case_id = '165097'
    ...
    def run(self):
        ...
        assert_true(self, paste_jpeg_option_selected, 'The paste-jpeg-file changed color to red which indicates that'
