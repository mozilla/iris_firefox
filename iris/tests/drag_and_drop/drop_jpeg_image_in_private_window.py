...
class Test(BaseTest):
    ...
    def __init__(self):
        ...
        self.meta = 'Drop single and multiple .jpeg images in demopage opened in Private Window'
        self.test_case_id = '165085'
    ...
    def run(self):
        ...
        drop_jpg_data_button_displayed = exists(drop_jpg_file_button_pattern, DEFAULT_SITE_LOAD_TIMEOUT)
        assert_true(self, drop_jpg_data_button_displayed, 'The demo website loaded successfully')

        click(drop_jpg_file_button_pattern)

        drop_jpg_option_selected = exists(drop_jpg_file_selected_button_pattern)
        assert_true(self, drop_jpg_option_selected, 'The drop-jpeg-file changed color to red which indicates that it '
                                                    'has been selected.')
        ...
        drag_drop(jpg_bak_file_pattern, drop_here_location.below(library_title_height*2))
        ...
        drag_drop(png_bak_file_pattern, drop_here_location.below(library_title_height*2))
