...
class Test(BaseTest):
    ...
    def run(self):
        ...
        drag_drop(pdf_bak_file_pattern, drop_here_pattern, DEFAULT_SHORT_FIREFOX_TIMEOUT)
        ...
        drag_drop(txt_bak_file_pattern, drop_here_pattern, DEFAULT_SHORT_FIREFOX_TIMEOUT)
