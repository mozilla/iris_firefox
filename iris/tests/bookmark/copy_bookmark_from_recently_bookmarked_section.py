...
class Test(BaseTest):
    ...
    def run(self):
        ...
        library_button_exists = exists(library_button_pattern, DEFAULT_SHORT_FIREFOX_TIMEOUT)
        assert_true(self, library_button_exists, 'View history, saved bookmarks and more section exists')

        click(library_button_pattern)

        bookmarks_menu_option_exists = exists(bookmarks_menu_option_pattern, DEFAULT_SHORT_FIREFOX_TIMEOUT)
        ...
        recently_wikipedia_bookmark_exists = exists(recently_wikipedia_bookmark_pattern, DEFAULT_SHORT_FIREFOX_TIMEOUT)
        ...
        try:
            menu_disappeared = wait_vanish(copy_option_pattern, DEFAULT_SHORT_FIREFOX_TIMEOUT)
        ...
        sidebar_bookmarks_header_exists = exists(sidebar_bookmarks_header_pattern, DEFAULT_SHORT_FIREFOX_TIMEOUT)
        assert_true(self, sidebar_bookmarks_header_exists, 'Bookmarks sidebar exists')

        sidebar_bookmarks_toolbar_exists = exists(sidebar_bookmarks_toolbar_pattern, DEFAULT_SHORT_FIREFOX_TIMEOUT)
        ...
        try:
            paste_option_disappeared = wait_vanish(paste_option_pattern, DEFAULT_SHORT_FIREFOX_TIMEOUT)
        ...
        wiki_sidebar_bookmark_exists = exists(wiki_sidebar_bookmark_pattern, DEFAULT_SHORT_FIREFOX_TIMEOUT)
