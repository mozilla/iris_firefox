...
class Test(BaseTest):
    ...
    def run(self):
        ...
        sidebar_bookmarks_header_exists = exists(sidebar_bookmarks_header_pattern, DEFAULT_UI_DELAY_LONG)
        assert_true(self, sidebar_bookmarks_header_exists, 'Bookmarks sidebar exists')

        sidebar_bookmarks_toolbar_exists = exists(sidebar_bookmarks_toolbar_pattern, DEFAULT_UI_DELAY_LONG)
