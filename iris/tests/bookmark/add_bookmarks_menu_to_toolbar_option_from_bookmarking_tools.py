...
class Test(BaseTest):
    def __init__(self):
        ...
        self.meta = 'Add Bookmarks Menu to Toolbar\' option from Bookmarking Tools '
        self.test_case_id = '165477'
    ...
    def run(self):
        ...
        bookmarks_menu_added_to_toolbar_exists = exists(bookmarks_menu_added_to_toolbar_pattern, DEFAULT_UI_DELAY_LONG)
        assert_true(self, bookmarks_menu_added_to_toolbar_exists, 'The Bookmarks menu is correctly added '
