...
class Test(BaseTest):
    def __init__(self):
        ...
        self.meta = 'View Bookmarks Toolbar\' from Bookmarking Tools'
        self.test_case_id = '165480'
    ...
    def run(self):
        ...
        assert_true(self, bookmarks_toolbar_exists, 'Bookmarks Toolbar is displayed under the URL bar.')