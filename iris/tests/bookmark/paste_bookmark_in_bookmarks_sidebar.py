...
class Test(BaseTest):
    ...
    def run(self):
        ...
        library_menu_bookmarks_exists = exists(LibraryMenu.BOOKMARKS_OPTION, DEFAULT_UI_DELAY_LONG)
        ...
        try:
            bookmarks_is_copied = wait_vanish(copy_option_pattern, DEFAULT_UI_DELAY_LONG)
        ...
        bookmarks_sidebar_menu_header_exists = exists(SidebarBookmarks.BOOKMARKS_HEADER, DEFAULT_UI_DELAY_LONG)
        ...
        try:
            paste_option_not_exists = wait_vanish(paste_option_pattern, DEFAULT_UI_DELAY_LONG)
