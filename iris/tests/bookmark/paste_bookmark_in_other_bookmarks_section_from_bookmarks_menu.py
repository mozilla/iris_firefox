...
class Test(BaseTest):
    ...
    def __init__(self):
        ...
        self.meta = '[Win/Linux] Paste a bookmark in \'Other Bookmarks\' section from Bookmarks menu'
    ...
    def run(self):
        ...
        assert_true(self, bookmarks_content_displayed, '"Bookmarks toolbar" folder content is displayed')
        ...
        loop_location = Location(SCREEN_WIDTH, bookmark_toolbar_top_menu_location.y)
        ...
        assert_true(self, context_menu_cut_displayed, 'Context menu "Cut" option is displayed')

        click(cut_option_pattern)

        bookmarks_menu_still_displayed = exists(other_bookmarks_pattern)
        assert_true(self, bookmarks_menu_still_displayed, 'Bookmarks menu still displayed after bookmark was cut')

        click(other_bookmarks_pattern)

        other_bookmarks_displayed = exists(firefox_bookmark_top_menu_pattern)
        assert_true(self, other_bookmarks_displayed, '"Other bookmarks" folder content is displayed')
        ...
        loop_location = Location(SCREEN_WIDTH, other_bookmarks_location.y)
        ...
        assert_true(self, context_menu_paste_displayed, 'Context menu "Paste" option is displayed')

        click(paste_option_pattern)

        bookmark_pasted = exists(getting_started_pattern)
        assert_true(self, bookmark_pasted, 'Expected bookmark was pasted into "Other bookmarks" folder')
