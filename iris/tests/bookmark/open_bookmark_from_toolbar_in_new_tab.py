...
class Test(BaseTest):
    ...
    def run(self):
        ...
        open_in_new_tab_option_available = exists(open_in_new_tab_option_pattern, DEFAULT_TINY_FIREFOX_TIMEOUT)
        ...
        iris_tab_exists = exists(LocalWeb.IRIS_LOGO_INACTIVE_TAB, DEFAULT_SHORT_FIREFOX_TIMEOUT)
        assert_true(self, iris_tab_exists, '\'Iris\' tab is still displayed on the screen')
