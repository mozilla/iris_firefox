...
class Test(BaseTest):
    ...
    def run(self):
        ...
        paste_option_exists = exists(paste_option_pattern, Settings.SHORT_FIREFOX_TIMEOUT)
        ...
        bookmark_not_deleted = exists(mozilla_firefox_predefined_bookmarks_pattern, Settings.FIREFOX_TIMEOUT)
