...
class Test(BaseTest):
    ...
    def run(self):
        ...
        bookmark_getting_started_exists = exists(bookmark_getting_started_pattern, DEFAULT_UI_DELAY_LONG)
        ...
        if not Settings.is_mac():
            ...
            properties_window_exists = exists(name_before_editing_pattern, DEFAULT_UI_DELAY_LONG)
            assert_true(self, properties_window_exists, 'Properties for "Getting Started" window is opened')

        name_before_exists = exists(name_before_editing_pattern, DEFAULT_UI_DELAY_LONG)
        assert_true(self, name_before_exists, 'Name field exists')

        location_before_exists = exists(location_before_editing_pattern, DEFAULT_UI_DELAY_LONG)
        assert_true(self, location_before_exists, 'Location field exists')

        tags_before_exists = exists(tags_before_editing_pattern, DEFAULT_UI_DELAY_LONG)
        assert_true(self, tags_before_exists, 'Tags field exists')

        keyword_before_exists = exists(keyword_before_editing_pattern, DEFAULT_UI_DELAY_LONG)
        ...
        new_modified_bookmark_exists = exists(new_modified_bookmark_pattern, DEFAULT_UI_DELAY_LONG)
        ...
        name_after_exists = exists(name_after_editing_pattern, DEFAULT_UI_DELAY_LONG)
        assert_true(self, name_after_exists, 'Name field changes are correctly saved')

        type(Key.TAB)

        location_after_exists = exists(location_after_editing_pattern, DEFAULT_UI_DELAY_LONG)
        assert_true(self, location_after_exists, 'Location field changes are correctly saved')

        type(Key.TAB)

        tags_after_exists = exists(tags_after_editing_pattern, DEFAULT_UI_DELAY_LONG)
        ...
        keyword_after_exists = exists(keyword_after_editing_pattern, DEFAULT_UI_DELAY_LONG)
