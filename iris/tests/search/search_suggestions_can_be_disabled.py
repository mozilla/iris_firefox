...
class Test(BaseTest):
    ...
    def run(self):
        ...
        search_suggestions_displayed_content_search_pattern = Pattern('search_suggestions_displayed_content_search.png')
        search_suggestions_displayed_search_bar_pattern = Pattern('search_suggestions_displayed_search_bar.png')
        ...
        suggestions_search_not_displayed = exists(search_suggestions_are_disabled_search_bar_pattern,
        ...
        suggestions_search_displayed = exists(search_suggestions_displayed_search_bar_pattern,
                                              Settings.FIREFOX_TIMEOUT)
        ...
        suggestions_content_displayed = exists(search_suggestions_displayed_content_search_pattern, Settings.FIREFOX_TIMEOUT)
