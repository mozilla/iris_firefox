...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        saved_logins_list_available_first = exists(
            saved_logins_list_available_first_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        saved_logins_list_available_second = exists(
            saved_logins_list_available_second_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert (
            saved_logins_list_available_first and saved_logins_list_available_second
