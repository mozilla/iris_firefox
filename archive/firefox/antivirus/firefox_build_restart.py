...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        assert exists(
            browser_console_opened_pattern, Settings.DEFAULT_SITE_LOAD_TIMEOUT
        ), "Browser console is opened."

        click(browser_console_opened_pattern)
        restart_via_console()
        assert exists(
            browser_console_opened_pattern, Settings.DEFAULT_HEAVY_SITE_LOAD_TIMEOUT
