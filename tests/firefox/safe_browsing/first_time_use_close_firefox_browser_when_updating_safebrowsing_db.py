...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        local_directory_row_pattern = Pattern("local_directory_row.png").similar(0.7)
        show_in_button_pattern = Pattern("show_in_button.png").similar(0.7)
        ...
        local_directory_row_region = Region(
            ...
            local_directory_row_width * 10,
            local_directory_row_height,
        )
