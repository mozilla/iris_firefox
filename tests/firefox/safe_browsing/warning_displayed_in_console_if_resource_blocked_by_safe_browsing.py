...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        console_region = Region(
            ...
            Screen.SCREEN_WIDTH - console_element_picker_width,
            console_element_picker_height * 10,
        )
        ...
        testsafebrowsing_page_loaded = exists(
            testsafebrowsing_tab_pattern, FirefoxSettings.SITE_LOAD_TIMEOUT, tabs_region
        )
