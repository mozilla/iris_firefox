...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        assert "extended-validation.badssl.com" in text_displayed, (
            "The URL is properly loaded and green background "
        ...
        certificate_additional_details_region = Region(
            connection_lock_location.x,
            connection_lock_location.y + connection_lock_height,
            connection_lock_width * 20,
            connection_lock_height * 20,
        )
