...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        tls_connection_encrypted_message_pattern = Pattern(
            "tls_1_2_connection_encrypted_message.png"
        )
        ...
        assert text_displayed in "tls-v1-2.badssl.com", (
            "The URL is properly loaded and green background page is "
        ...
        tls_connection_encrypted_message_displayed = exists(
            tls_connection_encrypted_message_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert tls_connection_encrypted_message_displayed, (
