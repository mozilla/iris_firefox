...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        send_websites_option_unchecked = exists(
            do_not_track_unselected_pattern, FirefoxSettings.FIREFOX_TIMEOUT, send_websites_option_region
        )
        ...
        do_not_track_selected = exists(
            do_not_track_selected_pattern, FirefoxSettings.FIREFOX_TIMEOUT, send_websites_option_region
        )
