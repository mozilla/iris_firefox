...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        new_firefox_content_blocking_label_displayed = exists(
            LocationBar.NEW_FIREFOX_CONTENT_BLOCKING_LABEL, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        differences_to_expect_label_displayed = exists(
            ContentBlockingTour.DIFFERENCES_TO_EXPECT_LABEL, FirefoxSettings.FIREFOX_TIMEOUT
        )
