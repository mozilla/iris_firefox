...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        private_window_is_loaded = exists(
            PrivateWindow.private_window_pattern, FirefoxSettings.SITE_LOAD_TIMEOUT
        )
        ...
        navigated_to_preferences = exists(
            preferences_privacy_find_field_pattern, FirefoxSettings.SITE_LOAD_TIMEOUT
        )
        assert (
        ...
        new_tab_is_opened = exists(
            Tabs.NEW_TAB_HIGHLIGHTED, FirefoxSettings.SITE_LOAD_TIMEOUT
        )
