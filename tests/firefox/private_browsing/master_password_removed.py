...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        new_tab_is_opened = exists(
            Tabs.NEW_TAB_HIGHLIGHTED, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        assert (
            unchecked_use_master_password_checkbox_exists is True
        ...
        assert (
            ok_button_available_in_change_master_password is True
        ...
        available_button_ok_password_change_succeeded = exists(
            button_ok_password_change_succeeded_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert (
            available_button_ok_password_change_succeeded is True
        ), "Button OK is available."
        ...
        assert (
            master_password_box_is_checked is True
        ), "Master password is set in Normal Browsing tab."

        #  Change master password in Private mode
        new_private_window()

        private_browsing_tab_logo = exists(
            private_browsing_tab_logo_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert (
            private_browsing_tab_logo is True
        ), "A new private window is successfully loaded."
        ...
        assert (
            checked_use_master_password_checkbox_exists is True
        ...
        assert (
            remove_button_available_in_change_master_password is True
        ...
        assert unchecked_use_master_password_checkbox_exists is True, (
