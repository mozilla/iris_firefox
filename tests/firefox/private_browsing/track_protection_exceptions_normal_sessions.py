...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        assert navigated_to_preferences, 'The about:preferences#privacy page is successfully displayed.'
        ...
        assert privacy_strict_checkbox_checked_displayed, 'The "Strict" content blocking' \
        ...
        assert tracking_protection_shield_displayed, 'The Tracking protection shield' \
        ...
        assert third_party_tracker_correctly_blocked_displayed, 'Simulated third-party tracker' \
        ...
        assert first_party_tracker_correctly_blocked_displayed, 'Simulated first-party tracker' \
                                                                ' was correctly loaded is displayed.'

        dnt_signal_correctly_sent_displayed = exists(dnt_signal_correctly_sent_text)
        assert dnt_signal_correctly_sent_displayed, 'The DNT signal was correctly sent is displayed.'
        ...
        if not exists(firefox_tracker_site_content_pattern,
        ...
        firefox_tracker_site_logo_displayed = exists(firefox_tracker_site_content_pattern,
                                                     FirefoxSettings.FIREFOX_TIMEOUT)
        assert firefox_tracker_site_logo_displayed, 'Site is reloaded after turning off content blocking'
        ...
        assert tracking_content_detected_pattern_displayed, 'On hover, the tracking protection' \
        ...
        assert third_party_tracker_incorrectly_loaded_displayed, 'Simulated third-party tracker' \
        ...
        assert exceptions_content_blocking_panel_displayed, 'The Exceptions - Content Blocking panel' \
                                                            ' is successfully displayed.'

        itstrap_site_exception_displayed = exists(itstrap_site_exception_selected_pattern)
        assert itstrap_site_exception_displayed, 'The previously accessed website is displayed' \
