...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        print_preview_mode_exists = exists(
            print_preview_mode_enabled_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert (
            print_preview_mode_exists is True
        ), "Print-preview mode is successfully enabled."
        ...
        after_scroll_down_content_not_exists = exists(
            scroll_content_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        assert after_scroll_down_content_not_exists is False, (
            "Content is gone after scrolling down"
