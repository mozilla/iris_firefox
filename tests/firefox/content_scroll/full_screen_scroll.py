...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        mouse_scroll_done = scroll_until_pattern_found(
        ...
        returned_home_arrows = scroll_until_pattern_found(
            soap_article_title,
            scroll_up,
            num_of_scroll_iterations=100,
        ...
        if OSHelper.is_mac():
            page_bottom_reached = scroll_until_pattern_found(
                wikimedia_logo_pattern,
                type,
