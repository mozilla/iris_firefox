...
class Test(FirefoxTest):
    ...
    def test_run(self, firefox):
        ...
        image_rich_pdf_last_page_contents_pattern = Pattern(
            "image_rich_pdf_last_page_contents.png"
        )
        image_rich_pdf_first_page_contents_pattern = Pattern(
            "image_rich_pdf_first_page_contents.png"
        )
        ...
        assert (
            image_rich_pdf_last_page_contents_pattern
        ), "Navigation via 'End' key works properly"

        type(Key.HOME)

        assert (
            image_rich_pdf_first_page_contents_pattern
        ), "Navigation via 'Home' key works properly"
        ...
        assert exists(
            image_rich_pdf_third_page_contents_pattern
        ), "'Zoom out' button works as expected"
