...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        image_rich_pdf_third_page_contents_pattern = Pattern("image_rich_pdf_third_page_contents.png").similar(0.6)
        ...
        assert exists(
            image_rich_pdf_first_page_contents_pattern, FirefoxSettings.HEAVY_SITE_LOAD_TIMEOUT
        ...
        scrolling_down_works = scroll_until_pattern_found(
            image_rich_pdf_third_page_contents_pattern, scroll, (scroll_height,), num_of_scroll_iterations=50
        )
        assert scrolling_down_works, "Scrolling down via mouse wheel works properly"

        scrolling_up_works = scroll_until_pattern_found(
            image_rich_pdf_first_page_contents_pattern, scroll, (50,), num_of_scroll_iterations=50
        )
        ...
        arrow_down_navigation_works = scroll_until_pattern_found(
            image_rich_pdf_third_page_contents_pattern, type, (Key.DOWN,), num_of_scroll_iterations=50
        )
        ...
        arrow_up_navigation_works = scroll_until_pattern_found(
            image_rich_pdf_first_page_contents_pattern, type, (Key.UP,), num_of_scroll_iterations=50
        )
        ...
        assert scroll_until_pattern_found(
            image_rich_pdf_third_page_contents_pattern, type, (Key.PAGE_DOWN,)
        ), "Navigation via 'Page Down' key works properly"

        assert scroll_until_pattern_found(
            image_rich_pdf_first_page_contents_pattern, type, (Key.PAGE_UP,)
        ...
        assert exists(
            image_rich_pdf_first_page_contents_pattern
        ...
        assert exists(zoom_in_button_pattern, region=zoom_buttons_region), "'Zoom in' button available"
        ...
        assert exists(zoom_out_button_pattern, region=zoom_buttons_region), "'Zoom out' button available"
