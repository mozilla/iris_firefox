...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        pdf_opened = exists(
            first_page_contents_pattern, FirefoxSettings.SITE_LOAD_TIMEOUT
        )
        ...
        downloads_menu_opened = exists(
            Library.DOWNLOADS, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
        )
        ...
        pdf_listed_in_downloads_section = exists(
            pdf_in_downloads_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
        )
        assert (
            pdf_listed_in_downloads_section
        ), "Downloaded PDF document is listed in Library's 'Downloads' section"
