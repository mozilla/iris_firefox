...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        dev_console_inspector_button_pattern = Pattern("dev_console_inspector_button.png").similar(0.7)
        last_page_document_contents_pattern = Pattern("last_page_contents_pres_mode.png")
        exit_fullscreen_popup_pattern = Pattern("exit_fullscreen_popup.png").similar(0.7)
        ...
        rotate_counterclockwise_option_available = exists(
            rotate_counterclockwise_option_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
        )
        assert (
        ...
        inspect_element_option_works = exists(dev_console_inspector_button_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
