...
class Test(FirefoxTest):
    @pytest.mark.details(
        description='Navigate through found items using ENTER',
        locale=['en-US'],
        test_case_id='127258',
        test_suite_id='2085'
    )
    def run(self, firefox):
        ...
        assert operating_disparate_highlighted_displayed and operating_all_displayed, \
            'All the matching words/characters are found. The first one has a green background highlighted, and ' \
        ...
        operating_all_highlighted_displayed = exists(LocalWeb.SOAP_WIKI_OPERATING_ALL_HIGHLIGHTED,
                                                     FirefoxSettings.FIREFOX_TIMEOUT)
        assert operating_disparate_displayed and operating_all_highlighted_displayed, \
        ...
        assert one_of_two_matches_displayed and two_of_two_matches_displayed, \
