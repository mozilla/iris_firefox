...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        soap_so_large_title_selected_pattern = Pattern(
            "soap_so_large_title_selected.png"
        )
        soap_soa_large_title_selected_pattern = Pattern(
            "soap_soa_large_title_selected.png"
        )
        ...
        selected_label_exists = exists(
            soap_large_title_selected_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert (
        ...
        unselected_label_exists = exists(
            soap_label_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        soa_selected_exists = exists(
            soap_soa_large_title_selected_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        soap_clean_exists = exists(
            soap_large_title_unselected_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
