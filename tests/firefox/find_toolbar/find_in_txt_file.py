...
class Test(FirefoxTest):
    @pytest.mark.details(
        description="Search on a text file (.txt)", locale=["en-US"], test_case_id="127273", test_suite_id="2085"
    )
    def run(self, firefox):
        ...
        text_second_occurrence_unhighlighted = exists(
            text_second_occurrence_unhighlighted_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
