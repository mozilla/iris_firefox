...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        long_word_selected_label_pattern = Pattern("long_word_selected_label.png").similar(0.6)
        ...
        start_label_exists = exists(
            long_word_unselected_label_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        selected_label_exists = exists(
            long_word_selected_label_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert (
