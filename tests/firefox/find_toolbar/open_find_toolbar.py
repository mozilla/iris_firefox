...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        try:
            ...
            raise FindError(
                "Could not get the x-coordinate of the Highlight All button"
            )
        ...
        correct_order = (
            find_toolbar_x
            < button_highlight_all_x
            < button_match_case_x
            < button_whole_words_x
        )
        assert (
            correct_order
        ...
        if OSHelper.is_linux():
            ...
            menu_bar_find_in_page_displayed = exists(
                MenuBar.Edit.EDIT_FIND_IN_PAGE, FirefoxSettings.TINY_FIREFOX_TIMEOUT
            )
        ...
        hamburger_menu_displayed = exists(
            NavBar.HAMBURGER_MENU, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        hamburger_menu_find_in_page_displayed = exists(
            HamburgerMenu.HAMBURGER_MENU_FIND_IN_PAGE_PATTERN,
        ...
        if hamburger_menu_find_in_page_displayed:
            ...
            raise FindError(
                "The Find in page tab in the Hamburger menu is not displayed"
            )

        edit_select_all()
        edit_delete()
        find_toolbar_opened_hamburger = exists(
            FindToolbar.FINDBAR_TEXTBOX, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert find_toolbar_opened_hamburger, (
            "The Find Toolbar is successfully displayed by "
