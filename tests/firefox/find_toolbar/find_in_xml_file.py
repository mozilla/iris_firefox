...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        first_occurrence_highlighted_pattern = Pattern(
            "xml_text_first_occurrence_pattern.png"
        )
        second_occurrence_highlighted_pattern = Pattern(
            "xml_text_second_occurrence_pattern.png"
        ).similar(0.6)
        ...
        xml_url_logo_exists = exists(
            xml_page_logo_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        text_first_occurrence_exists = exists(
        ...
        text_second_occurrence_exists = exists(
        ...
        assert (
            text_first_occurrence_exists
        ), "The first occurrence is highlighted before scrolling."

        repeat_key_down(4)
        repeat_key_up(4)

        text_first_occurrence_exists_after_scroll = exists(
            first_occurrence_highlighted_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert (
            text_first_occurrence_exists_after_scroll
