...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        small_text_unselected_pattern = Pattern("small_text_unselected.png").similar(
            0.6
        )
        ...
        )  # https://bug1279751.bmoattachments.org/attachment.cgi?id=8762332
        page_is_opened = exists(
            small_text_unselected_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        small_text_unselected_exists = exists(
            small_text_unselected_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        small_text_selected_exists = exists(
            small_text_selected_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
