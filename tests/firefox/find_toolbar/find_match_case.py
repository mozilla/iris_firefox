...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        soap_envelope_label_selected_pattern = (
        ...
        selected_label_exists = exists(
            soap_envelope_label_selected_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert (
        ...
        unselected_label_exists = exists(
            soap_xml_label_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        first_label_is_green = exists(
            soap_label_selected_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert (
            first_label_is_green
        ), "The next matching words/characters have a green background highlighted"

        other_label_is_unhighlighted = exists(
            soap_xml_label_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
