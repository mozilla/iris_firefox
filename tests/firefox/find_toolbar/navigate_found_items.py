...
class Test(FirefoxTest):
    @pytest.mark.details(
        description="Navigate through found items", locale=["en-US"], test_case_id="127249", test_suite_id="2085"
    )
    def run(self, firefox):
        ...
        cleaning_see_label_exists = exists(
            LocalWeb.SOAP_WIKI_CLEANING_SEE_SELECTED_LABEL, FirefoxSettings.FIREFOX_TIMEOUT
        )
