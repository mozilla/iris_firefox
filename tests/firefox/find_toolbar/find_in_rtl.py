...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        page_loaded_anchor_exists = exists(
            rtl_second_not_highlighted_pattern, FirefoxSettings.SITE_LOAD_TIMEOUT
        )
        ...
        assert rtl_deleted_selected_exists, (
            "Typing and deleting work. The caret is placed on the left side "
            "of the word."
        )
        ...
        assert (
            selected_label_exists
        ), "After navigation The first one has a green background highlighted."
