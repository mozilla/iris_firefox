...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        assert (
            firefox.application.build_id == get_firefox_build_id_from_about_config()
        ...
        assert firefox.application.build_id == FirefoxUtils.get_firefox_build_id(
            firefox.application.path
        ), "API for Firefox build ID is correct"
        assert firefox.application.channel == FirefoxUtils.get_firefox_channel(
            firefox.application.path
        ), "API for Firefox channel is correct"
