...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        proper_hamburger_menu_region = Region(
            0, iris_tab_logo_location.y, width=Screen.SCREEN_WIDTH, height=Screen.SCREEN_HEIGHT / 4
        )
        ...
        firefox_tab_region_before = Region(
            firefox_tab_location_before.x - tab_width, 0, width=tab_width * 3, height=Screen.SCREEN_HEIGHT
        )
        firefox_tab_region_after = Region(
            (Screen.SCREEN_WIDTH / 2) - tab_width, 0, width=tab_width * 3, height=Screen.SCREEN_HEIGHT
        )
        ...
        focus_tab_region_before = Region(
            0, focus_tab_location_before.y - (tab_height / 2), width=Screen.SCREEN_WIDTH, height=tab_height * 2
        )
        focus_tab_region_after = Region(
            0, (Screen.SCREEN_HEIGHT / 2) - tab_height * 5, width=Screen.SCREEN_WIDTH, height=tab_height * 10
        )
        ...
        try:
            focus_tab_dragged = wait_vanish(
                focus_test_site_tab_pattern, FirefoxSettings.FIREFOX_TIMEOUT, focus_tab_region_before
            )
        ...
        focus_tab_dropped = exists(
            focus_test_site_tab_pattern, FirefoxSettings.FIREFOX_TIMEOUT, region=focus_tab_region_after
        )
        ...
        try:
            firefox_test_site_tab_dragged = wait_vanish(
                firefox_test_site_tab_pattern, FirefoxSettings.FIREFOX_TIMEOUT, firefox_tab_region_before
            )
        ...
        firefox_tab_dropped = exists(
            firefox_test_site_tab_pattern, FirefoxSettings.FIREFOX_TIMEOUT, region=firefox_tab_region_after
        )
        ...
        hamburger_menu_button_exists = exists(
            hamburger_menu_button_pattern, FirefoxSettings.FIREFOX_TIMEOUT, region=proper_hamburger_menu_region
        )
