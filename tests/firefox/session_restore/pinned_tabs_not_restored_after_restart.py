...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        firefox_pinned_tab_pattern = Pattern("firefox_pinned_tab.png").similar(0.7)
        ...
        focus_tab_pinned = exists(
            focus_pinned_tab_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        firefox_test_tab_exists = exists(
            firefox_tab_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        firefox_test_tab_pinned = exists(
            firefox_pinned_tab_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        assert firefox_test_tab_pinned and focus_tab_pinned, (
            "Browser starts with two windows. Both "
