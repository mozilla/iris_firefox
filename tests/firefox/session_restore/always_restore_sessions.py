...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        restore_previous_session_checkbox_available = exists(
            restore_previous_session_unchecked_pattern,
        ...
        checkbox_restore_previous_session_checked = exists(
            restore_previous_session_checked_pattern
        )
        assert (
            checkbox_restore_previous_session_checked
        ...
        next_tab()
        checkbox_restore_previous_session_checked = exists(
            restore_previous_session_checked_pattern.similar(0.6),
        ...
        restore_previous_session_unchecked_exists = exists(
            restore_previous_session_unchecked_pattern
        )
        assert (
