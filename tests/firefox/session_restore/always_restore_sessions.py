...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        restore_previous_session_checkbox_available = exists(
            restore_previous_session_unchecked_pattern, FirefoxSettings.SITE_LOAD_TIMEOUT
        )
        assert (
        ...
        checkbox_restore_previous_session_checked = exists(
            restore_previous_session_checked_pattern.similar(0.6), timeout=FirefoxSettings.HEAVY_SITE_LOAD_TIMEOUT
        )
