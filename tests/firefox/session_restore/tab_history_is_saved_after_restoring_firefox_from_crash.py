...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        restore_previous_session_checkbox_displayed = exists(
            restore_previous_session_checkbox_pattern
        )
        assert (
            restore_previous_session_checkbox_displayed
        ...
        assert (
            test_site_opened
        ), "Focus test website history was successfully remembered."
        ...
        assert (
            test_site_opened
        ), "Pocket test website history was successfully remembered."
        ...
        assert test_site_opened, (
            "Mozilla test website history was successfully remembered. The tab history was "
