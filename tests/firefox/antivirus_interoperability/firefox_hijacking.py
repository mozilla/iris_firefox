...
class Test(FirefoxTest):
    ...
    def test_run(self, firefox):
        ...
        assert exists(default_search_engine_pattern, 10), 'The default search engine is not changed.'
        ...
        assert exists(firefox_home_default_pattern, 10), 'The default home page is not changed.'
