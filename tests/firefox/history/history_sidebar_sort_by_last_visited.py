...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        history_sort_last_visited = exists(
            history_sidebar_sort_by_last_visited_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        history_sidebar_sort_by_last_visited = exists(
            history_sidebar_items_sort_by_last_visited_pattern, FirefoxSettings.SITE_LOAD_TIMEOUT
        )
