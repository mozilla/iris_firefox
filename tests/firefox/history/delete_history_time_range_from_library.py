...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        history_today = exists(
            history_today_pattern.similar(0.6), FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        history_today_region = Region(
            history_today_location.x,
            history_today_location.y,
            history_today_width,
            history_today_height,
        )

        history_today = exists(
            "Today", FirefoxSettings.FIREFOX_TIMEOUT, history_today_region
        )
        assert history_today, "History Today button available"
