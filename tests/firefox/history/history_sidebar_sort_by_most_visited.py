...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        history_sidebar_sort_by_most_visited = exists(
            history_sidebar_sort_by_most_visited_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        history_sidebar_items_sorted = exists(
            history_sidebar_items_sorted_pattern.similar(0.7), FirefoxSettings.SITE_LOAD_TIMEOUT
        )
