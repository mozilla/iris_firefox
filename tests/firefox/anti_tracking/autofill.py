...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        twitter_tab_favicon_exists = exists(
            twitter_tab_favicon_pattern, FirefoxSettings.SITE_LOAD_TIMEOUT
        )
        assert twitter_tab_favicon_exists, "Twitter page successfully opens"

        login_field_exists = exists(
            login_field_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
        )
        ...
        password_field_exists = exists(
            password_field_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
        )
        ...
        save_button_exists = exists(
            save_credentials_button_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert (
            save_button_exists
        ), "Save button displays after entering twitter login and password"
        ...
        twitter_tab_favicon_exists = exists(
            twitter_tab_favicon_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
        )
        assert twitter_tab_favicon_exists, "Twitter page successfully opens"
