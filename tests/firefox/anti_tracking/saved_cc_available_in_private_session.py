...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        expiration_month_dropdown_exists = exists(
        ...
        expiration_year_dropdown_exists = exists(
            expiration_year_dropdown_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
        )
        assert expiration_year_dropdown_exists, (
        ...
        billing_address_dropdown_exists = exists(
            billing_address_dropdown_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
        )
        assert billing_address_dropdown_exists, (
            "'Billing address' dropdown is displayed on the " "'Edit Credit Card' popup"
        )

        click(billing_address_dropdown_pattern)

        billing_address_dropdown_item_exists = exists(
            billing_address_dropdown_item_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
        )
        assert billing_address_dropdown_item_exists, (
