...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        address_first_name_field_exists = exists(address_first_name_field_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT)
        ...
        popup_name_on_card_field_exists = exists(popup_name_on_card_field_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT)
        ...
        expiration_year_dropdown_exists = exists(expiration_year_dropdown_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT)
