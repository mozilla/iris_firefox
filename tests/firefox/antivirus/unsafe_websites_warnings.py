...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        google4_row_region = Screen().new_region(
            google4_row_location.x,
            google4_row_location.y,
            Screen.SCREEN_WIDTH - google4_row_location.x,
            google4_row_height,
        )
        ...
        mozilla_row_region = Screen().new_region(
            ...
            mozilla_row_location.y,
            Screen.SCREEN_WIDTH - mozilla_row_location.x,
            google4_row_height,
        )
        ...
        desktop_download_warning_width, desktop_download_warning_height = (
            desktop_download_warning_title_pattern.get_size()
        )

        desktop_download_warning_region = Screen().new_region(
            desktop_download_warning_location.x,
        ...
        for download_tests in range(6):
            region_to_click = Screen().new_region(
                first_test_label_location.x,
                coordinate_y,
