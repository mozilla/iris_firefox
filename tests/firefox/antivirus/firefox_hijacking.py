...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        this_time_search_region = Region(this_time_search_location.x, this_time_search_location.y, this_time_width * 3,
                                         this_time_height)

        ebay_one_off_displayed = exists(ebay_one_off_button_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT,
