...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        drop_png_data_button_displayed = exists(drop_png_file_button_pattern, Settings.DEFAULT_SITE_LOAD_TIMEOUT)
        ...
        assert drop_png_option_selected, (
            "The drop-png-file changed color to red which indicates that it " "has been selected."
        )
