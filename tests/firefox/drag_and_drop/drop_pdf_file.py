...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        drop_pdf_file_selected_button_pattern = Pattern(
            "drop_pdf_file_selected_button.png"
        )
        ...
        drop_pdf_file_button_displayed = exists(
            drop_pdf_file_button_pattern, Settings.DEFAULT_SITE_LOAD_TIMEOUT
        )
        ...
        assert drop_pdf_option_selected, (
            "The drop-pdf-file changed color to red which indicates that it "
            "has been selected."
        )
        ...
        test_file_pdf_located = exists(
            pdf_bak_file_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        drag_drop(
            pdf_bak_file_pattern, drop_here_pattern, duration=drag_and_drop_duration
        )
        ...
        test_file_txt_located = exists(
            txt_bak_file_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
