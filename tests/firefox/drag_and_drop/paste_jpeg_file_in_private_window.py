...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        paste_jpeg_file_selected_button_pattern = Pattern(
            "paste_jpeg_file_selected_button.png"
        )
        ...
        paste_jpeg_file_button_displayed = exists(
            paste_jpeg_button_pattern, Settings.SITE_LOAD_TIMEOUT
        )
        ...
        assert paste_jpeg_option_selected, (
            "The paste-jpeg-file changed color to red which indicates that "
