...
class Test(FirefoxTest):
    @pytest.mark.details(
        description="Paste .pdf File in demopage opened in Private Window",
        locale=["en-US"],
        test_case_id="165093",
        test_suite_id="5259",
    ...
    def run(self, firefox):
        ...
        paste_pdf_file_selected_button_pattern = Pattern("paste_pdf_file_selected_button.png")
        ...
        paste_pdf_file_button_displayed = exists(paste_pdf_button_pattern, Settings.SITE_LOAD_TIMEOUT)
        assert paste_pdf_file_button_displayed, "The demo website loaded successfully"

        click(paste_pdf_button_pattern)

        paste_pdf_option_selected = exists(paste_pdf_file_selected_button_pattern)
        assert paste_pdf_option_selected, (
            "The paste-pdf-file changed color to red which indicates that it " "has been selected."
        )
