...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        paste_pdf_file_selected_button_pattern = Pattern(
            "paste_pdf_file_selected_button.png"
        )
        ...
        paste_pdf_file_button_displayed = exists(
            paste_pdf_button_pattern, Settings.SITE_LOAD_TIMEOUT
        )
