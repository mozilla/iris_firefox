...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        assert matching_message_exists, '"Matching" appears under the "Drop Stuff Here" area, the expected result is' \
        ...
        not_matching_message_displayed = scroll_until_pattern_found(not_matching_message_pattern, type,
                                                                    (Key.PAGE_DOWN,))
        assert not_matching_message_displayed, '"Not Matching" appears under the "Drop Stuff Here"' \
