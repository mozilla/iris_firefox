...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        not_matching_region = Rectangle(not_matching_message_location.x, not_matching_message_location.y,
        ...
        matching_region = Rectangle(not_matching_message_location.x, not_matching_message_location.y,
