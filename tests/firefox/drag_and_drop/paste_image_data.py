...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        assert paste_image_data_selected, (
            'The "paste-image-data" changed color to red which indicates that '
        ...
        two_images_displayed_on_the_page = exists(first_picture_pattern) and exists(
            second_picture_pattern
        )
        ...
        assert matching_message_appears, (
            '"Matching" appears under the "Drop Stuff Here" area, the expected '
