...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        preferences_page_opened = exists(
            web_search_options_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert (
        ...
        web_search_option_width, web_search_option_height = (
            web_search_options_pattern.get_size()
        )
        ...
        ), "The search bar is displayed on top of the Homepage."
        ...
        assert (
            google_logo_content_search_field is True
        ), "The search bar is displayed on top of the New Tab page."
        ...
        google_logo_content_search_field = exists(
            google_logo_content_search_field_pattern
        )
        assert (
            google_logo_content_search_field is False
        ), "The search bar is not displayed anymore on the Home page."
        ...
        assert (
            google_logo_content_search_field is False
        ), "The search bar is not displayed anymore on the New Tab page."
        ...
        assert (
            google_logo_content_search_field is False
        ), "The search bar is not displayed anymore in the New Window."
