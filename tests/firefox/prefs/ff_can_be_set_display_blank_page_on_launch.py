...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        home_page_displayed = not exists(Utils.TOP_SITES, FirefoxSettings.FIREFOX_TIMEOUT) and not exists(
            Tabs.NEW_TAB_HIGHLIGHTED
        )

        no_other_tabs_displayed = not exists(mozilla_tab_not_focused_pattern) and not exists(
            wiki_logo_unactive_tab_pattern
        )
