...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        test_search_region = Region(
            0, url_bar_location.y + url_bar_height, Screen.SCREEN_WIDTH // 3, Screen.SCREEN_HEIGHT // 3
        )
        ...
        assert use_address_bar_selected, (
            'The option "Use the address bar for search bar and navigation" is selected ' "by default. "
        )
        ...
        assert exists(
            search_result_default_pattern, FirefoxSettings.SITE_LOAD_TIMEOUT
