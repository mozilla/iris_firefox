...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        assert wrong_spelled_word_underlined_red, (
            "The word that was spelled wrong is underlined with a red " "squiggly line."
        )
        ...
        check_your_spelling_checked = find_in_region_from_pattern(
            check_your_spelling_checked_pattern, AboutPreferences.CHECKED_BOX
        )
        ...
        check_your_spelling_unchecked = find_in_region_from_pattern(
            check_your_spelling_unchecked_pattern, AboutPreferences.UNCHECKED_BOX
        )
