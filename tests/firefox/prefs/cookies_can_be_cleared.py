...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        assert (
            ...
            + "web content. Clearing cache data will not affect your logins."
            in warning_text_displayed
        ), (
            '"Clearing all cookies and site data stored by Firefox may sign you out of websites and remove offline '
        ...
        time.sleep(FirefoxSettings.TINY_FIREFOX_TIMEOUT / 2)
        assert (
            "Selecting ‘Clear Now’ will clear all cookies and site data stored by Firefox. This may sign you out "
            + "of websites and remove offline web content."
            in warning_text_displayed
        ), (
