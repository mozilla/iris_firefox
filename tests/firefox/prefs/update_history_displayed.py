...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        choose_language_button = scroll_until_pattern_found(
            show_update_history_button_pattern, Mouse().scroll, (None, -scroll_height), 140, 1
        )
        ...
        assert no_updates_installed, (
            '"No updates installed yet" displayed. A list with updates that were installed ' "is correctly displayed."
        )
