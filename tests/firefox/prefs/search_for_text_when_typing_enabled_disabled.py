...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        assert (
            search_for_text_start_typing_checked
        ...
        quick_find_toolbar_does_not_appear_while_typing = not exists(
            quick_find_toolbar_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
        )
        assert (
            quick_find_toolbar_does_not_appear_while_typing
