...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        font_of_site_exists = scroll_until_pattern_found(
            font_of_site_pattern,
            Mouse().scroll,
            (0, -value),
            20,
        ...
        advanced_button_exists = exists(
            advanced_button_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert advanced_button_exists, "Advanced button exists"

        click(advanced_button_pattern)

        fonts_subdialog_label_exists = exists(
            fonts_subdialog_label_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        pages_have_own_fonts_checked_exists = exists(
            AboutPreferences.CHECKED_BOX, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert pages_have_own_fonts_checked_exists, (
        ...
        pages_have_own_fonts_unchecked_exists = exists(
            AboutPreferences.UNCHECKED_BOX, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert pages_have_own_fonts_unchecked_exists, (
            ' "Allow pages to choose their own fonts,'
        ...
        try:
            fonts_subdialog_label_exists = wait_vanish(
                fonts_subdialog_label_pattern, FirefoxSettings.FIREFOX_TIMEOUT
            )
        ...
        font_of_site_changed_exists = scroll_until_pattern_found(
            font_of_site_changed_pattern,
            Mouse().scroll,
            (0, -value),
            20,
            FirefoxSettings.TINY_FIREFOX_TIMEOUT / 2,
        ...
        font_of_site_exists = exists(
            font_of_site_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
