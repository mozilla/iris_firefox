...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        font_of_site_exists = scroll_until_pattern_found(
            font_of_site_pattern, Mouse().scroll, (0, -value), 20, FirefoxSettings.TINY_FIREFOX_TIMEOUT / 2
        )
        ...
        assert pages_have_own_fonts_checked_exists, (
            ' "Allow pages to choose their own fonts,' ' instead of your selections above" checked exists'
        )
        ...
        assert pages_have_own_fonts_unchecked_exists, (
            ' "Allow pages to choose their own fonts,' ' instead of your selections above" unchecked exists'
        )
        ...
        font_of_site_changed_exists = scroll_until_pattern_found(
            font_of_site_changed_pattern, Mouse().scroll, (0, -value), 20, FirefoxSettings.TINY_FIREFOX_TIMEOUT / 2
        )
