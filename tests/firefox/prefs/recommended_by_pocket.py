...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        recommended_by_pocket_label_pattern = Pattern("recommended_by_pocket_label.png").similar(0.7)
        ...
        preferences_page_opened = exists(recommended_by_pocket_option, FirefoxSettings.FIREFOX_TIMEOUT)
        assert preferences_page_opened, (
            'The option "Recommended by Pocket" is displayed and has the ' "corresponding icon "
        )
        ...
        pocket_section_displayed = exists(recommended_by_pocket_label_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        assert pocket_section_displayed, "The Recommended by Pocket section is displayed underneath Top Sites section."
        ...
        pocket_option_selected = exists(AboutPreferences.UNCHECKED_BOX, region=pocket_option_region)
        ...
        assert pocket_section_displayed, "The Recommended by Pocket section is not displayed anymore"
