...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        add_search_bar_in_toolbar_deselected = exists(
            add_search_bar_in_toolbar_deselected_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        search_bar_displayed = exists(
            LocationBar.SEARCH_BAR_MAGNIFYING_GLASS, FirefoxSettings.SHORT_FIREFOX_TIMEOUT, region=Screen.RIGHT_HALF
        )
