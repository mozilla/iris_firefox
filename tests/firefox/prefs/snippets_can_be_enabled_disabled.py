...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        preferences_page_opened = exists(
            AboutPreferences.PRIVACY_AND_SECURITY_BUTTON_SELECTED.similar(0.7), FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        snippets_option_exists = exists(snippets_options_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        assert snippets_option_exists, "The Snippets option is displayed."

        snippet_option_location = find(snippets_options_pattern)
        snippet_option_width, snippet_option_height = snippets_options_pattern.get_size()
        ...
        snippets_option_selected = exists(
            AboutPreferences.CHECKED_BOX, FirefoxSettings.FIREFOX_TIMEOUT, snippet_option_region
        )
        assert snippets_option_selected, "The option is selected by default."

        navigate("about:home")

        snippets_displayed = exists(home_page_snippets_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        assert snippets_displayed is True, "The Snippets section is displayed underneath Highlights section."
        ...
        snippets_option_selected = exists(
            AboutPreferences.UNCHECKED_BOX, FirefoxSettings.FIREFOX_TIMEOUT, snippet_option_region
        )
        ...
        snippets_displayed = exists(home_page_snippets_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        assert snippets_displayed is False, "The Snippets section is not displayed underneath Highlights section."
