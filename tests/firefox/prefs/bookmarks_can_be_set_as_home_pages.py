...
class Test(FirefoxTest):
    @pytest.mark.details(
        description="Bookmarks can be set as home pages ", locale=["en-US"], test_case_id="2241", test_suite_id="161468"
    )
    def run(self, firefox):
        ...
        home_option_displayed = exists(
            default_setting_home_pattern, FirefoxSettings.FIREFOX_TIMEOUT, homepage_section_region
        )
        ...
        bookmarks_toolbar_folder_exists = exists(bookmarks_toolbar_folder_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
