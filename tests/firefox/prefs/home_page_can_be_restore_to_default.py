...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        home_page_displayed = exists(
            LocalWeb.FIREFOX_IMAGE, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        restore_defaults_region = Region(
            Screen.SCREEN_WIDTH / 4, 0, Screen.SCREEN_WIDTH, Screen.SCREEN_HEIGHT / 4
        )

        restore_defaults_displayed = exists(
            "Restore Defaults", FirefoxSettings.FIREFOX_TIMEOUT, restore_defaults_region
        )
        ...
        assert (
            home_option_displayed
        ), "The fields beneath are automatically changed to the Default settings."
        ...
        assert (
            home_page_displayed
        ), "The browser opens with the about:home page displayed."
