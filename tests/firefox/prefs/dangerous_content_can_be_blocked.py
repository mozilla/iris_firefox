...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        block_dangerous_content_pattern = Pattern("block_dangerous_deceptive_content.png")
        ...
        block_dangerous_content_checked = exists(block_dangerous_content_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        ...
        region = Rectangle(
            image_find(phishing_warning_label_pattern).x, image_find(phishing_warning_label_pattern).y, width, height
        )
        ...
        assert see_details_button_displayed, "A page warning you that the content is dangerous is displayed."
        ...
        phishing_page_loaded = exists(phishing_page_loaded_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        see_details_button_not_displayed = not exists(see_details_button_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT)
