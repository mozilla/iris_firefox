...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        request_checkbox_unchecked = find_in_region_from_pattern(request_english_versions_unchecked_pattern.similar(0.6),
        ...
        request_checkbox_checked = find_in_region_from_pattern(request_english_versions_unchecked_pattern.similar(0.6),
                                                               AboutPreferences.CHECKED_BOX.similar(0.7),
                                                               FirefoxSettings.FIREFOX_TIMEOUT)
