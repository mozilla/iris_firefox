...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        when_you_open_link_checked = find_in_region_from_pattern(
            when_you_open_link_checked_pattern, AboutPreferences.CHECKED_BOX
        )

        if not when_you_open_link_checked:
            when_you_open_link_unchecked = find_in_region_from_pattern(
                when_you_open_link_unchecked_pattern, AboutPreferences.UNCHECKED_BOX
            )
