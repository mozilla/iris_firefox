...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        default_font_picker_exists = exists(
            default_font_picker_pattern.similar(0.6), FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        font_is_changed_to_another = exists(
            page_with_mod_font_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
