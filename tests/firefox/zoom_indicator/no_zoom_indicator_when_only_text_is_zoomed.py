...
class Test(FirefoxTest):
    ...
    @pytest.mark.details(
        description='This test case checks that no zoom indicator is displayed in the url bar when the \'zoom text ' \
    ...
    def run(self, firefox):
        ...
        assert expected, 'Zoom indicator not displayed in the url bar after the \'zoom text only\' option is set.'
