...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        edit_buttons_below_zoom_buttons_pattern = (
            HamburgerMenu.EDIT_BUTTONS_BELOW_ZOOM_BUTTONS
        )
        ...
        expected = exists(
            edit_buttons_below_zoom_buttons_pattern.similar(0.25),
            FirefoxSettings.FIREFOX_TIMEOUT,
            region=new_region,
        )
        assert (
            expected
        ), "Control buttons for zooming appear above the Cut/Copy/Paste buttons."
