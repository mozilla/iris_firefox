...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        expected = exists(
            zoom_control_90_pattern, FirefoxSettings.FIREFOX_TIMEOUT, region=new_region
        )
        assert (
            expected
        ...
        assert (
            expected
        ), "Zoom indicator is correctly displayed in the url bar after zoom level decrease."
