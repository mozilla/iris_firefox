...
class Test(FirefoxTest):
    @pytest.mark.details(
        description="This is a test case that checks the zoom in functionality from the menu bar.",
        locale=["en-US"],
        test_case_id="7455",
        test_suite_id="242",
    )
    def run(self, firefox):
        ...
        region_2 = create_region_for_url_bar()

        expected = exists(
            url_bar_default_zoom_level_pattern.similar(0.92), FirefoxSettings.FIREFOX_TIMEOUT, region=region_2
        )
