...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        bookmarks_folder_available_in_toolbar = exists(most_visited_folder_pattern,
        ...
        assert open_option_available is True, '\'Open\' option is available in context menu after right-click ' \
                                              'at the bookmark'
        ...
        assert bookmark_opened_in_current_tab is False, 'The page that was previously displayed in the current tab ' \
