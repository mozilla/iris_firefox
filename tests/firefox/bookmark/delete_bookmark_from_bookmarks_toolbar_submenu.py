...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        try:
            ...
            assert getting_started_bookmark_removed is True, (
                "Getting Started bookmark deleted from Firefox menu >" " Bookmarks > Bookmarks Toolbar section"
            )
        except FindError:
        ...
        assert bookmark_removed_from_toolbar is False, (
            "The selected file is deleted from the **Bookmarks Toolbar**" " section."
        )
