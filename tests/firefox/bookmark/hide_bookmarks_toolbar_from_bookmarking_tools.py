...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        ), "Bookmarks Toolbar is correctly displayed under the URL bar"
        ...
        assert (
            hide_bookmarks_toolbar_exists is True
        ), "Bookmarking Tools window contains Hide Bookmarks Toolbar"
        ...
        view_bookmarks_toolbar_exists = exists(view_bookmarks_toolbar_pattern)
        assert view_bookmarks_toolbar_exists is True, (
            "The Hide Bookmarks Toolbar button changes its state to "
