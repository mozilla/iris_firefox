...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        bookmarks_toolbar_menu_option_available = exists(
            bookmarks_toolbar_menu_option_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
        )
        assert bookmarks_toolbar_menu_option_available is True, (
