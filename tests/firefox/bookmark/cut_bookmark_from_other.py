...
class Test(FirefoxTest):
    ...
    @pytest.mark.details(
        description='Cut a bookmark from "Other Bookmarks" section - Bookmarks menu',
        locale=['en-US'],
        test_case_id='163215',
        test_suite_id='2525',
    ...
    def run(self, firefox):
        ...
        bookmark_context_menu_displayed = exists(cut_option_pattern)
        ...
        assert bookmark_cut_off is False, 'Bookmark is properly cut off'
