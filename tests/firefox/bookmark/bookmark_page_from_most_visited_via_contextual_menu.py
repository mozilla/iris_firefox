...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        folders_expander_exists = exists(
            Bookmarks.StarDialog.PANEL_FOLDERS_EXPANDER.similar(0.6), FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert folders_expander_exists is True, "Folders expander is displayed"

        click(Bookmarks.StarDialog.PANEL_FOLDERS_EXPANDER)

        bookmarks_toolbar_option_exists = exists(Library.BOOKMARKS_TOOLBAR, FirefoxSettings.FIREFOX_TIMEOUT)
