...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        other_bookmarks_option_pattern = Bookmarks.StarDialog.PANEL_FOLDER_DEFAULT_OPTION.similar(
            0.6
        )
        bookmarks_toolbar_option = Bookmarks.StarDialog.PANEL_OPTION_BOOKMARK_TOOLBAR.similar(
            0.6
        )
        ...
        assert (
            wiki_bookmark_toolbar_folder_displayed is True
        ...
        ), "Bookmark is correctly copied in the selected session"
