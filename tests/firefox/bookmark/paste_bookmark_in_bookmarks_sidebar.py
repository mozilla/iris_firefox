...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        library_menu_bookmarks_exists = exists(
        ...
        bookmark_from_library_exists = exists(
            bookmark_from_library_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
        )
        ...
        try:
            bookmarks_is_copied = wait_vanish(
                copy_option_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
            )
        ...
        bookmarks_sidebar_menu_header_exists = exists(
            SidebarBookmarks.BOOKMARKS_HEADER, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
        )
        assert (
            bookmarks_sidebar_menu_header_exists is True
        ...
        try:
            paste_option_not_exists = wait_vanish(
                paste_option_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
            )
        ...
        bookmark_from_sidebar_exists = exists(
            bookmark_from_sidebar_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
        )
        assert (
            bookmark_from_sidebar_exists is True
        ), "The bookmark is correctly copied in the selected section."
