...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        choose_option_displayed = exists(
            Bookmarks.StarDialog.PANEL_OPTION_CHOOSE.similar(0.6),
            region=stardialog_region,
        )
        ...
        destination_folders_displayed = exists(
            destination_folders_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert (
            destination_folders_displayed
        ), "Edit This Bookmark panel is displayed with all the destination folders."
