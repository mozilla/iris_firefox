...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        edit_this_bookmark_option_pattern = Pattern(
            "edit_this_bookmark_option.png"
        ).similar(0.7)
        ...
        edit_this_bookmark_option_exists = exists(
            edit_this_bookmark_option_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
