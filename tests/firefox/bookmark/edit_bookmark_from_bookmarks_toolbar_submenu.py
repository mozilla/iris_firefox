...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        most_visited_folder_exists = exists(
            firefox_menu_most_visited_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        getting_started_exists = exists(
            getting_started_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        bookmark_properties_opened = exists(
            name_field_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert (
            bookmark_properties_opened is True
        ), "Bookmark properties window is opened"
        ...
        bookmark_edited = exists(
            LocalWeb.FOCUS_BOOKMARK_SMALL, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert (
            bookmark_edited is True
        ), "The window is dismissed and all the changes are correctly saved"
        ...
        location_edited = exists(
            location_edited_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
