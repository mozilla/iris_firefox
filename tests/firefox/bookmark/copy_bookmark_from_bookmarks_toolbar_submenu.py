...
class Test(FirefoxTest):
    ...
    @pytest.mark.details(
        description='Copy a bookmark from the Bookmarks Toolbar submenu',
        locale=['en-US'],
        test_case_id='163488',
        test_suite_id='2525',
    ...
    def run(self, firefox):
        ...
        assert bookmark_exists_in_toolbar is True, 'The file/folder from the previous step is pasted in the ' \
