...
class Test(FirefoxTest):
    @pytest.mark.details(
        description="Open a bookmark in a New Window from 'Mozilla Firefox' section",
        locale=["en-US"],
        test_case_id="163232",
        test_suite_id="2525",
    ...
    def run(self, firefox):
        ...
        context_menu_open_in_a_new_window_option_displayed = exists(
            context_menu_open_in_a_new_window_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert context_menu_open_in_a_new_window_option_displayed is True, (
            "Context menu Open in a New Tab option " "is displayed"
        )
