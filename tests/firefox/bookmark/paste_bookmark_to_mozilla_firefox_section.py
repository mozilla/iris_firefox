...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        getting_started_bookmark_exists = exists(getting_started_in_toolbar_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        assert getting_started_bookmark_exists is True, 'Getting started bookmark exists'

        right_click(getting_started_in_toolbar_pattern)

        copy_option_exists = exists(copy_option_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        ...
        bookmark_pasted = exists(getting_started_in_toolbar_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
