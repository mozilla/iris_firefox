...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        edit_bookmark_name_before_exists = exists(
            edit_bookmark_name_before_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
        )
        assert edit_bookmark_name_before_exists is True, "Name field exists"

        edit_bookmark_folder_before_exists = exists(
            edit_bookmark_folder_before_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
        )
        assert edit_bookmark_folder_before_exists is True, "Folder field exists"

        edit_bookmark_tags_before_exists = exists(
            edit_bookmark_tags_before_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
        )
        ...
        edit_bookmark_name_after_exists = exists(
            edit_bookmark_name_after_pattern, FirefoxSettings.SHORT_FIREFOX_TIMEOUT
        )
