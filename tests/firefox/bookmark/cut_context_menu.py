...
class Test(FirefoxTest):
    ...
    @pytest.mark.details(
        description='Cut context menu option works properly.',
        locale=['en-US'],
        test_case_id='168936',
        test_suite_id='2525',
    ...
    def run(self, firefox):
        ...
        assert pasted_bookmark_assertion is True, 'Moz Bookmark has been moved to a different directory, cut option ' \
                                                  'works as expected.'
