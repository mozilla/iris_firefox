...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        assert (
            library_icon_exists is True
        ), " View history, saved bookmarks and more section button exists"
        ...
        assert (
            menu_exists is True
        ), "View history, saved bookmarks and more section is displayed."
