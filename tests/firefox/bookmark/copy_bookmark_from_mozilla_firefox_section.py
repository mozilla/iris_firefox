...
class Test(FirefoxTest):
    ...
    @pytest.mark.details(
        description='Copy a bookmark from \'Mozilla Firefox\' section',
        locale=['en-US'],
        test_case_id='163377',
        test_suite_id='2525',
    ...
    def run(self, firefox):
        ...
        other_bookmarks_empty_label_exists = exists(other_bookmarks_empty_label_pattern,
                                                    FirefoxSettings.FIREFOX_TIMEOUT)
        ...
        assert bookmark_not_deleted is True, 'Bookmark pasted in selected section without being deleted from the ' \
                                             'previous one.'
