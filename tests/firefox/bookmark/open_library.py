...
class Test(FirefoxTest):
    @pytest.mark.details(description="Open Library", locale=["en-US"], test_case_id="169255", test_suite_id="2525")
    def run(self, firefox):
        ...
        if OSHelper.is_linux() or OSHelper.is_mac():
            ff_menu_show_all_bookmarks_pattern = Pattern("ff_menu_show_all_bookmarks.png").similar(0.7)
