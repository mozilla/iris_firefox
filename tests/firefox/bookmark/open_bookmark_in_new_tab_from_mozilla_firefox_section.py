...
class Test(FirefoxTest):
    @pytest.mark.details(
        description="Open a bookmark in a New Tab from 'Mozilla Firefox' section",
        locale=["en-US"],
        test_case_id="163231",
        test_suite_id="2525",
    ...
    def run(self, firefox):
        ...
        context_menu_open_in_a_new_tab_option_displayed = exists(
            context_menu_open_in_a_new_tab_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert context_menu_open_in_a_new_tab_option_displayed is True, (
