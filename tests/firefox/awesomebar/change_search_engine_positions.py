...
class Test(FirefoxTest):
    ...
    def test_run(self):
        ...
        pattern_list = [google_one_off_button_pattern, bing_one_off_button_pattern,twitter_one_off_button_pattern,wikipedia_one_off_button_pattern,amazon_one_off_button_pattern]
