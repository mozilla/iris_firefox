...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        search_in_new_tab_exists = exists(
            search_in_new_tab, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        localhost_string_exists = exists(
            this_time_search_with, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert (
            localhost_string_exists
        ), "Searched string found at the bottom of the drop-down list."

        bing_one_off_button_exists = exists(
            bing_one_off_button, FirefoxSettings.FIREFOX_TIMEOUT
        )
        ...
        bing_search_results_localhost_exists = exists(
            bing_search_results_localhost, FirefoxSettings.FIREFOX_TIMEOUT
        )
        assert (
