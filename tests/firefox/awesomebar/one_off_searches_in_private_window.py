...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        twitter_result_displayed = exists(
            new_tab_twitter_search_results_pattern, FirefoxSettings.FIREFOX_TIMEOUT
        ) or exists(new_tab_twitter_search_results_pattern2, FirefoxSettings.FIREFOX_TIMEOUT)
