...
class Test(FirefoxTest):
    ...
    def test_run(self,firefox):
        ...
        assert  expected, 'Navigation through search suggestions list 10 times does not get in focus the ''\'Google\' search engine. TAB navigation works only in search suggestions list.'
