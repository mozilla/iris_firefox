...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        go_to_first_page_button_pattern = Pattern("go_to_first_page_button.png").similar(0.6)
        rotate_clockwise_button_pattern = Pattern("rotate_clockwise_button.png").similar(0.6)
        pdf_file_last_page_contents_pattern = Pattern("last_page_contents.png")
        go_to_last_page_button_pattern = Pattern("go_to_last_page_button.png").similar(0.6)
        ...
        home_button_navigation_works = exists(pdf_file_page_contents_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        assert home_button_navigation_works, "Navigation via 'Home' key works properly"

        type(Key.END)

        end_button_navigation_works = exists(pdf_file_last_page_contents_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        ...
        navigation_via_previous_page_button_works = exists(history_chapter_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        assert (
        ...
        next_page_button_available = region_top.exists(next_page_button_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        ...
        tools_button_available = region_top.exists(tools_button_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        ...
        page_contents_rotated = exists(pdf_file_last_page_contents_rotated_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        ...
        page_rotated_back = exists(pdf_file_last_page_contents_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        ...
        hand_tool_available = region_right.exists(hand_tool_button_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        ...
        text_selection_tool_available = region_right.exists(text_selection_tool_button, FirefoxSettings.FIREFOX_TIMEOUT)
        assert text_selection_tool_available, "'Text selection tool' button available in 'Tools' menu"

        click(text_selection_tool_button)

        text_to_select_present_on_page = exists(last_page_text_contents_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        ...
        text_selection_tool_works = exists(text_selected_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        ...
        if not OSHelper.is_linux():
            document_properties_opened = exists(document_properties_filename_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        ...
        try:
            expected = region_bottom.wait_vanish(doc_properties_close_button_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        ...
        jump_to_page_field_available = region_top.exists(jump_to_page_field_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        ...
        first_page_opened = exists(pdf_file_page_contents_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
