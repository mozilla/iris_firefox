...
class Test(FirefoxTest):
    ...
    def run(self, firefox):
        ...
        one_off_bar_displayed = exists(google_one_off_button_private_window_pattern, FirefoxSettings.FIREFOX_TIMEOUT)
        ...
        google_button_found = region.exists(
            google_one_off_button_private_window_pattern, FirefoxSettings.SITE_LOAD_TIMEOUT
        )
