...
help_script(){
    ...
    if [[ "$OSTYPE" == "linux-gnu" ]]; then
            ...
            echo -e "\n ${A} Checking if Python3 is installed \n"
            if command -v python3 &>/dev/null; then
                echo -e "${GREEN}  ---> ${C} Python 3 is installed. ${C} ${STD}\n"
                echo -e "${GREEN}  ---> ${C} Verify which Python 3 version is installed. ${C} ${STD} \n"
                echo -e "\n  ---> Version: $(python3 -V) \n"
                echo -e "\n  ---> Location: $(which python3) \n"
                echo -e "\n ${YELLOW} Checking if Python3.7 is installed\n"
                if [[ $(python3 -V | grep "Python 3.7") =~ 3.7 ]]; then
                    echo -e "${GREEN}  ---> ${C} Python 3.7 is installed under python3 command. ${C} ${STD}\n"
                    if [[ $(python3.7 -V | grep "Python 3.7") =~ 3.7 ]]; then
                    echo -e "${GREEN}  ---> ${C} Also Python 3.7 can be accessed using the python3.7 command. ${C} ${STD}\n"
                    fi
                elif command -v python3.7 &>/dev/null; then
                    echo -e "${GREEN}  ---> ${C} Python 3.7 is installed under python3.7 command. ${C} ${STD}\n"
                    echo -e "\n  ---> Version: $(python3.7 --version)"
                    echo -e "\n  ---> Location: $(which python3.7) \n"
                else
                  echo -e "\n${RED}  ---> ${X} Error... Python 3.7 is not installed. ${X} ${STD} \n"
                  echo -e "\n  ---> Your Python default version is: $(python --version)\n"
                fi
            else
                echo -e "\n${RED}  ---> ${X} Error... Python 3 is not installed. ${X} ${STD} \n"
                echo -e "\n  ---> Your Python default version is: $(python --version)\n"
            fi
            ...
            if command -v pip3 &>/dev/null; then
                echo -e "${GREEN}  ---> ${C} Verify which Pip 3 version is installed. ${C} ${STD}\n"
                echo -e "${GREEN}  ---> ${C} Pip is installed. ${C} ${STD} \n"
                echo -e "\n  ---> Version: $(pip3 --version)"
                echo -e "\n  ---> Location: $(which pip3) \n"
                echo -e "${YELLOW}  ---> ${C} Verify if Python3.7 Pip version is installed. ${C} ${STD}\n"
                if [[ $(python3.7 -m pip --version | grep "python3.7") =~ python3.7 ]]; then
                    echo -e "${GREEN}  ---> ${C} Python3.7 Pip is installed. ${C} ${STD} \n"
                    echo -e "\n  ---> Version and location: $(python3 -m pip --version)"
                fi
            elif [[ $(python3.7 -m pip --version | grep "pip") =~ pip ]]; then
                echo -e "${YELLOW}  ---> ${C} Check which Python3.7 Pip version is installed. ${C} ${STD}\n"
                echo -e "${GREEN}  ---> ${C} Python3.7 Pip is installed. ${C} ${STD} \n"
                echo -e "\n  ---> Version and location: $(python3 -m pip --version) "
            else
                echo -e "\n${RED}  ---> ${X} Error... Pip3 not found. Please run the Iris Bootstrap. ${X} ${STD}\n"
            fi

            echo -e "\n ${A} Checking if Pipenv is installed \n"
            if command -v pipenv &>/dev/null; then
                echo -e "${GREEN}  ---> ${C} Pipenv is installed. ${C} ${STD} \n"
                echo -e "${GREEN}  ---> ${C} Verify which Pipenv version is installed. ${C} ${STD}\n"
                echo -e "\n  ---> Version: $(pipenv --version)"
                echo -e "\n  ---> Location: $(which pipenv) \n"
                echo -e "${YELLOW}  ---> ${C} Verify if Python3.7 Pipenv version is installed. ${C} ${STD}\n"
                if [[ $(python3.7 -m pipenv | grep "python 3.7") =~ "python 3.7" ]]; then
                    echo -e "${GREEN}  ---> ${C} Python3.7 Pipenv is installed. ${C} ${STD} \n"
                    echo -e "\n  ---> Version and location: $(python3.7 -m pipenv)"
                fi
            elif [[ $(python3.7 -m pipenv| grep "python 3.7") =~ pip ]]; then
                echo -e "${YELLOW}  ---> ${C} Verify which Python3.7 Pipenv version is installed. ${C} ${STD}\n"
                echo -e "${GREEN}  ---> ${C} Python3.7 Pipenv is installed. ${C} ${STD} \n"
                echo -e "\n  ---> Version and location: $(python3.7 -m pipenv)"
            else
            ...
            if command -v virtualenv &>/dev/null; then
                echo -e "${GREEN}  ---> ${C} Virtualenv is installed. ${C} ${STD} \n"
                echo -e "\n  ---> Version: $(virtualenv --version)"
                echo -e "\n  ---> Location: $(which virtualenv) \n"
                echo -e "${YELLOW}  ---> ${C} Verify if Python3.7 Virtualenv is installed. ${C} ${STD}\n"
                if [[ $(python3.7 -m virtualenv | grep "python3.7") =~ "python3.7" ]]; then
                    echo -e "${GREEN}  ---> ${C} Python3.7 virtualenv is installed. ${C} ${STD} \n"
                    echo -e "\n  ---> Version and location: $(python3.7 -m virtualenv --version)"
                fi
            elif [[ $(python3.7 -m virtualenv | grep "python3.7") =~ "python3.7" ]]; then
                    echo -e "${GREEN}  ---> ${C} Python3.7 virtualenv is installed. ${C} ${STD} \n"
                    echo -e "\n  ---> Version and location: $(python3.7 -m virtualenv --version)"
            else
            ...
            if [[ "$os_ver" =~ 10.14.* ]]; then
                echo -e "${GREEN}  ---> √ You are using MacOS Mojave "$os_ver". √ ${STD}\n"
            elif [[ "$os_ver" =~ 10.13.* ]]; then
                echo -e "${RED}  ---> ✘ You are running on Mac OS High Sierra. Currently is NOT supported. We recommend updating to Mojave. ✘ ${STD}\n"
            elif [[ "$os_ver" =~ 10.12.* ]]; then
                echo -e "${RED}  ---> ✘ You are running on Mac OS Sierra. Currently is NOT supported. We recommend updating to Mojave. ✘ ${STD}\n"
            else
            ...
            if command -v pip3 &>/dev/null; then
                ...
                echo -e "${YELLOW}  ---> ${C} Verify which Python3.7 Pip version is installed. ${C} ${STD}\n"
                echo -e "${GREEN}  ---> ${C} Python3.7 Pip is installed. ${C} ${STD} \n"
                echo -e "\n  ---> Version and location: $(python3 -m pip --version) "
            else
                echo -e "\n${RED}  ---> ${X} Error... Pip3 not found. Please run the Iris Bootstrap. ${X} ${STD}\n"
            ...
            if command -v virtualenv &>/dev/null; then
                ...
                echo -e "\n  ---> Version: $(virtualenv --version)"
                echo -e "\n  ---> Location: $(which virtualenv) \n"
                echo -e "${YELLOW}  ---> ${C} Verify if Python3.7 Virtualenv version is installed. ${C} ${STD}\n"
                if [[ $(python3.7 -m virtualenv | grep "python3.7") =~ "python3.7" ]]; then
                    echo -e "${GREEN}  ---> ${C} Python3.7 virtualenv is installed. ${C} ${STD} \n"
                    echo -e "\n  ---> Version and location: $(python3.7 -m virtualenv --version)"
                fi
            elif [[ $(python3.7 -m virtualenv | grep "python3.7") =~ "python3.7" ]]; then
                    echo -e "${YELLOW}  ---> ${C} Python3.7 virtualenv is installed. ${C} ${STD} \n"
                    echo -e "\n  ---> Version and location: $(python3.7 -m virtualenv --version)"
            else
                echo -e "\n${RED}  ---> ${X} Error... Virtualenv is not installed. Please run the Iris Bootstrap. ${X} ${STD}\n"
            fi
            ...
            if [[ $(pip3 show pyobjc | grep Name:) =~ "pyobjc" ]]; then
                echo -e "${GREEN}  ---> √ Pyobjc is installed. √ ${STD} Info: \n$(pip3 show pyobjc)"
            elif [[ $(python3.7 -m pip show pyobjc | grep Name:) =~ "pyobjc" ]]; then
                echo -e "${GREEN}  ---> √ Pyobjc is installed. √ ${STD} Info: \n$(python 3.7 -m pip show pyobjc)"
            else
            ...
            if [[ $(pip3 show pyobjc-core | grep Name:) =~ "pyobjc-core" ]]; then
                echo -e "${GREEN}  ---> √ Pyobjc-core is installed. √ ${STD} Info: \n$(pip3 show pyobjc-core)"
            elif [[ $(python3.7 -m pip show pyobjc-core | grep Name:) =~ "pyobjc-core" ]]; then
                echo -e "${GREEN}  ---> √ Pyobjc-core is installed. √ ${STD} Info: \n$(python3.7 -m pip show pyobjc-core)"
            else
            ...
            if command -v python3 &>/dev/null; then
                ...
                if [[ $(python3 -V | grep "Python 3.7") =~ 3.7 ]]; then
                    echo -e "${GREEN}  ---> ${C} Python 3.7 is installed under python3 command. ${C} ${STD}\n"
                    if [[ $(python3.7 -V | grep "Python 3.7") =~ 3.7 ]]; then
                    echo -e "${GREEN}  ---> ${C} Also Python 3.7 ca be accessed using the python3.7 command. ${C} ${STD}\n"
                    fi
                elif command -v python3.7 &>/dev/null; then
                    echo -e "${GREEN}  ---> ${C} Python 3.7 is installed under python3.7 command. ${C} ${STD}\n"
                    echo -e "\n  ---> Version: $(python3.7 --version)"
            ...
            echo -e "\n ${A} Checking if Pip is installed \n"
            if command -v pip3 &>/dev/null; then
                echo -e "${YELLOW}  ---> ${C} Verify which Pip 3 version is installed. ${C} ${STD}\n"
                echo -e "${GREEN}  ---> ${C} Pip is installed. ${C} ${STD} \n"
                echo -e "\n  ---> Version: $(pip3 --version)"
                echo -e "\n  ---> Location: $(which pip3) \n"
                echo -e "${YELLOW}  ---> ${C} Verify if Python3.7 Pip version is installed. ${C} ${STD}\n"
            ...
            if command -v pipenv &>/dev/null; then
                echo -e "${GREEN}  ---> ${C} Pipenv is installed. ${C} ${STD} \n"
                echo -e "${YELLOW}  ---> ${C} Verify which Pipenv version is installed. ${C} ${STD}\n"
                echo -e "\n  ---> Version: $(pipenv --version)"
                echo -e "\n  ---> Location: $(which pipenv) \n"
                echo -e "${YELLOW}  ---> ${C} Verify if Python3.7 Pipenv version is installed. ${C} ${STD}\n"
                if [[ $(python3.7 -m pipenv | grep "python 3.7") =~ "python 3.7" ]]; then
            ...
            if command -v virtualenv &>/dev/null; then
                ...
                echo -e "\n  ---> Version: $(virtualenv --version)"
                echo -e "\n  ---> Location: $(which virtualenv) \n"
                echo -e "${GREEN}  ---> ${C} Verify if Python3.7 Virtualenv version is installed. ${C} ${STD}\n"
                if [[ $(python3.7 -m virtualenv | grep "python3.7") =~ "python3.7" ]]; then
                    echo -e "${GREEN}  ---> ${C} Python3.7 virtualenv is installed. ${C} ${STD} \n"
                    echo -e "\n  ---> Version and location: $(python3.7 -m virtualenv --version)"
                fi
